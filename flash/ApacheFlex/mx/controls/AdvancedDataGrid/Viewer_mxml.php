 ...
 *================================================================
 * title: flex3sdk mxml?????????
 * file: AdvancedDataGridExample.php
 * path: F:\Flash\flex3.4\mxml\TourDeFlex\AdvancedDataGridExampleAdvancedDataGridExample\pgp
 * url:  http://hata2/HomePage/travel.coocan/Flash/ApacheFlex/mx/controls/AdvancedDataGrid/AdvancedDataGridExample.php
 * created: Time-stamp: <2010-09-21 15:35:01 kahata>
 * revision: $Id$
 * Programmed By: kahata
 * To compile:F:\Flash\flex3.4\flex_sdk_3.4.0.9271_mpl\bin\mxmlc.exe AdvancedDataGridExample.mxml
 * To run: 
 * link: 
 * description: Flex3, ActionScript ?????????
 *================================================================*
 * </pre>
 * @package    Flex3.4
 ...
 */
	require_once($_SERVER['DOCUMENT_ROOT'] . '/php1/lib/file.inc.php');
	require_once($_SERVER['DOCUMENT_ROOT'] . '/php1/lib/geshi/geshi_dsp.php'); 
 ...
 //-----------????-------------
	$source = isset($_GET['file']) ? $_GET['file'] : 'AdvancedDataGridExample.mxml';
...
<?php
    echo '<h3>' . $source . '</h3>';
    echo mb_convert_encoding(geshi_dsp($base.$source ,fileext($source),'number,onlyinclude'),'UTF-8','auto');
?>
  <hr /><br>
  <h2 style="clear:both;width=100% ">??????</h2>
  <ul>
<li><a href="menu(site).php" target="SideView">menu(site)</a></li>
<li><a href="http://livedocs.adobe.com/flex/3_jp/langref/index.html" target="_blank">AdobeR Flex! 3.2 ?????????????????/a></li>
