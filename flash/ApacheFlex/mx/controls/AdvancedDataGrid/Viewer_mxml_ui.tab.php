...
if(empty($_GET['dir'])){
	$filepath = 'http://hata2/HomePage/travel.coocan/Flash/ApacheFlex/mx/controls/AdvancedDataGrid/AdvancedDataGridExample.mxml';
	if($_SERVER['HTTP_HOST'] == 'kahata.travel.coocan.jp'){
	$filepath = str_replace('http://hata2/HomePage/travel.coocan','http://kahata.travel.coocan.jp','http://hata2/HomePage/travel.coocan/Flash/ApacheFlex/mx/controls/AdvancedDataGrid/AdvancedDataGridExample.mxml');
	}
...
function geshi_output($url){
	$path = $url;//str_replace('http://hata2','http://hata2',$url);
...
?>
  ...
  <p>
	...
	<li><a href="http://help.adobe.com/ja_JP/FlashPlatform/reference/actionscript/3/index.html" target="_blank">Adobe ActionScriptR 3??S3 ??PI ???????????</a></li>
