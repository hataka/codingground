...
[ExcludeClass]
public class _AdvancedDataGridExample_mx_managers_SystemManager
    extends mx.managers.SystemManager
    implements IFlexModuleFactory, ISWFContext
{
    public function _AdvancedDataGridExample_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "AdvancedDataGridExample" : String(params[0]);
    ...
    override    public function info():Object
    {
        if (!_info)
        {
            ...
            compiledResourceBundleNames: [ "collections", "components", "containers", "controls", "core", "datamanagement", "effects", "formatters", "layout", "skins", "styles" ],
            currentDomain: ApplicationDomain.currentDomain,
            mainClassName: "AdvancedDataGridExample",
            mixins: [ "_AdvancedDataGridExample_FlexInit", "_AdvancedDataGridExample_Styles" ],
