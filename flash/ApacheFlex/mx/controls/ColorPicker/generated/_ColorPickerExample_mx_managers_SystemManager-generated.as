...
[ExcludeClass]
public class _ColorPickerExample_mx_managers_SystemManager
    extends mx.managers.SystemManager
    implements IFlexModuleFactory, ISWFContext
{
    public function _ColorPickerExample_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "ColorPickerExample" : String(params[0]);
    ...
    override    public function info():Object
    {
        if (!_info)
        {
            ...
            compiledResourceBundleNames: [ "collections", "components", "controls", "core", "effects", "layout", "skins", "styles" ],
            currentDomain: ApplicationDomain.currentDomain,
            fontSize: "24",
            mainClassName: "ColorPickerExample",
            mixins: [ "_ColorPickerExample_FlexInit", "_ColorPickerExample_Styles", "mx.managers.systemClasses.ActiveWindowManager" ],
