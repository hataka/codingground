...
[ExcludeClass]
public class _SimpleComboBox_mx_managers_SystemManager
    extends mx.managers.SystemManager
    implements IFlexModuleFactory, ISWFContext
{
    public function _SimpleComboBox_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "SimpleComboBox" : String(params[0]);
    ...
    override    public function info():Object
    {
        if (!_info)
        {
            ...
            fontSize: "24",
            mainClassName: "SimpleComboBox",
            mixins: [ "_SimpleComboBox_FlexInit", "_SimpleComboBox_Styles", "mx.managers.systemClasses.ActiveWindowManager" ],
