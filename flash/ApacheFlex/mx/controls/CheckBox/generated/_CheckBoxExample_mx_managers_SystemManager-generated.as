...
[ExcludeClass]
public class _CheckBoxExample_mx_managers_SystemManager
    extends mx.managers.SystemManager
    implements IFlexModuleFactory, ISWFContext
{
    public function _CheckBoxExample_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "CheckBoxExample" : String(params[0]);
    ...
    override    public function info():Object
    {
        if (!_info)
        {
            ...
            compiledResourceBundleNames: [ "components", "containers", "controls", "core", "effects", "layout", "skins", "sparkEffects", "styles", "textLayout" ],
            currentDomain: ApplicationDomain.currentDomain,
            fontSize: "24",
            mainClassName: "CheckBoxExample",
            mixins: [ "_CheckBoxExample_FlexInit", "_CheckBoxExample_Styles", "mx.managers.systemClasses.ActiveWindowManager" ],
