...
[ExcludeClass]
public class _ButtonExample_mx_managers_SystemManager
    extends mx.managers.SystemManager
    implements IFlexModuleFactory, ISWFContext
{
    public function _ButtonExample_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "ButtonExample" : String(params[0]);
    ...
    override    public function info():Object
    {
        if (!_info)
        {
            ...
            compiledResourceBundleNames: [ "components", "core", "effects", "layout", "skins", "sparkEffects", "styles", "textLayout" ],
            currentDomain: ApplicationDomain.currentDomain,
            mainClassName: "ButtonExample",
            mixins: [ "_ButtonExample_FlexInit", "_ButtonExample_Styles" ],
