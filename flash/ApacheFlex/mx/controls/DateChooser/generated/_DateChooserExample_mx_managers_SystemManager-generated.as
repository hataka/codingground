...
[ExcludeClass]
public class _DateChooserExample_mx_managers_SystemManager
    extends mx.managers.SystemManager
    implements IFlexModuleFactory, ISWFContext
{
    public function _DateChooserExample_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "DateChooserExample" : String(params[0]);
    ...
    override    public function info():Object
    {
        if (!_info)
        {
            ...
            compiledResourceBundleNames: [ "SharedResources", "components", "controls", "core", "effects", "formatters", "layout", "skins", "styles" ],
            currentDomain: ApplicationDomain.currentDomain,
            fontSize: "24",
            mainClassName: "DateChooserExample",
            mixins: [ "_DateChooserExample_FlexInit", "_DateChooserExample_Styles" ],
