 ...
 *================================================================
 * title: flex3sdk mxml?????
 * file: HScrollBarExample.php
 * path: F:\Flash\flex3.4\mxml\TourDeFlex\HScrollBarExampleHScrollBarExample\pgp
 * url:  http://hata2/Flash/ApacheFlex/mx/controls/HScrollBar/HScrollBarExample.php
 * created: Time-stamp: <2010-09-21 15:35:01 kahata>
 * revision: $Id$
 * Programmed By: kahata
 * To compile:F:\Flash\flex3.4\flex_sdk_3.4.0.9271_mpl\bin\mxmlc.exe HScrollBarExample.mxml
 * To run: 
 * link: 
 ...
 */
 ...
 //-----------?? -------------
	$source = isset($_GET['file']) ? $_GET['file'] : 'HScrollBarExample.mxml';
