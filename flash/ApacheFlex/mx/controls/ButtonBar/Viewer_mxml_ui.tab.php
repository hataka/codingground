...
if(empty($_GET['dir'])){
	$filepath = 'http://hata2/HomePage/travel.coocan/Flash/ApacheFlex/mx/controls/ButtonBar/ButtonBarExample.mxml';
	if($_SERVER['HTTP_HOST'] == 'kahata.travel.coocan.jp'){
	$filepath = str_replace('http://hata2/HomePage/travel.coocan','http://kahata.travel.coocan.jp','http://hata2/HomePage/travel.coocan/Flash/ApacheFlex/mx/controls/ButtonBar/ButtonBarExample.mxml');
	}
