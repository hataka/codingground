...
[ExcludeClass]
public class _ButtonBarExample_mx_managers_SystemManager
    extends mx.managers.SystemManager
    implements IFlexModuleFactory, ISWFContext
{
    public function _ButtonBarExample_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "ButtonBarExample" : String(params[0]);
    ...
    override    public function info():Object
    {
        if (!_info)
        {
            ...
            mainClassName: "ButtonBarExample",
            mixins: [ "_ButtonBarExample_FlexInit", "_ButtonBarExample_Styles" ],
