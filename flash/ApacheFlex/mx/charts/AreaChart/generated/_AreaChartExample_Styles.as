...
public class _AreaChartExample_Styles
{
    [Embed(symbol='mx.skins.cursor.DragCopy', _file='F:/Programs/FlashDevelop/Tools/flexsdk/frameworks/libs/mx/mx.swc$defaults.css', original='Assets.swf', _resolvedSource='F:/Programs/FlashDevelop/Tools/flexsdk/frameworks/libs/framework.swc$Assets.swf', _pathsep='true', source='F:/Programs/FlashDevelop/Tools/flexsdk/frameworks/libs/framework.swc$Assets.swf', _line='515')]
    private static var _embed_css_Assets_swf__2141904558_mx_skins_cursor_DragCopy_606937453:Class;
    [Embed(symbol='mx.skins.cursor.BusyCursor', _file='F:/Programs/FlashDevelop/Tools/flexsdk/frameworks/libs/framework.swc$defaults.css', original='Assets.swf', _resolvedSource='F:/Programs/FlashDevelop/Tools/flexsdk/frameworks/libs/framework.swc$Assets.swf', _pathsep='true', source='F:/Programs/FlashDevelop/Tools/flexsdk/frameworks/libs/framework.swc$Assets.swf', _line='194')]
    private static var _embed_css_Assets_swf__2141904558_mx_skins_cursor_BusyCursor_288758019:Class;
    [Embed(symbol='mx.skins.cursor.DragLink', _file='F:/Programs/FlashDevelop/Tools/flexsdk/frameworks/libs/mx/mx.swc$defaults.css', original='Assets.swf', _resolvedSource='F:/Programs/FlashDevelop/Tools/flexsdk/frameworks/libs/framework.swc$Assets.swf', _pathsep='true', source='F:/Programs/FlashDevelop/Tools/flexsdk/frameworks/libs/framework.swc$Assets.swf', _line='517')]
    private static var _embed_css_Assets_swf__2141904558_mx_skins_cursor_DragLink_607199458:Class;
    [Embed(symbol='mx.skins.cursor.DragReject', _file='F:/Programs/FlashDevelop/Tools/flexsdk/frameworks/libs/mx/mx.swc$defaults.css', original='Assets.swf', _resolvedSource='F:/Programs/FlashDevelop/Tools/flexsdk/frameworks/libs/framework.swc$Assets.swf', _pathsep='true', source='F:/Programs/FlashDevelop/Tools/flexsdk/frameworks/libs/framework.swc$Assets.swf', _line='519')]
    private static var _embed_css_Assets_swf__2141904558_mx_skins_cursor_DragReject_880315081:Class;
    [Embed(symbol='mx.skins.cursor.DragMove', _file='F:/Programs/FlashDevelop/Tools/flexsdk/frameworks/libs/mx/mx.swc$defaults.css', original='Assets.swf', _resolvedSource='F:/Programs/FlashDevelop/Tools/flexsdk/frameworks/libs/framework.swc$Assets.swf', _pathsep='true', source='F:/Programs/FlashDevelop/Tools/flexsdk/frameworks/libs/framework.swc$Assets.swf', _line='518')]
    ...
    public static function init(fbs:IFlexModuleFactory):void
    {
        ...
        conditions = null;
        conditions = null;
        selector = new CSSSelector("mx.charts.chartClasses.ChartBase", conditions, selector);
        ...
        if (style.defaultFactory == null)
        {
            ...
            {
                this.dataTipRenderer = mx.charts.chartClasses.DataTip;
                this.fontSize = 10;
            };
        }
        ...
        conditions = null;
        conditions = null;
        selector = new CSSSelector("mx.charts.chartClasses.CartesianChart", conditions, selector);
        mergedStyle = styleManager.getMergedStyleDeclaration("mx.charts.chartClasses.CartesianChart");
        style = new CSSStyleDeclaration(selector, styleManager, mergedStyle == null);
        ...
        conditions = null;
        conditions = null;
        selector = new CSSSelector("mx.charts.AreaChart", conditions, selector);
        mergedStyle = styleManager.getMergedStyleDeclaration("mx.charts.AreaChart");
        style = new CSSStyleDeclaration(selector, styleManager, mergedStyle == null);
        ...
        conditions = null;
        conditions = null;
        selector = new CSSSelector("mx.charts.series.AreaSeries", conditions, selector);
        mergedStyle = styleManager.getMergedStyleDeclaration("mx.charts.series.AreaSeries");
        style = new CSSStyleDeclaration(selector, styleManager, mergedStyle == null);
        ...
        conditions = null;
        conditions = null;
        selector = new CSSSelector("mx.charts.series.LineSeries", conditions, selector);
        mergedStyle = styleManager.getMergedStyleDeclaration("mx.charts.series.LineSeries");
        style = new CSSStyleDeclaration(selector, styleManager, mergedStyle == null);
        ...
        conditions = null;
        conditions = null;
        selector = new CSSSelector("mx.charts.LineChart", conditions, selector);
        mergedStyle = styleManager.getMergedStyleDeclaration("mx.charts.LineChart");
        style = new CSSStyleDeclaration(selector, styleManager, mergedStyle == null);
        ...
        if (style.defaultFactory == null)
        {
            style.defaultFactory = function():void
            {
                ...
                this.labelClass = spark.components.Label;
        ...
        conditions = null;
        conditions = [];
        condition = new CSSCondition("class", "verticalAxisStyle");
        conditions.push(condition); 
        selector = new CSSSelector("", conditions, selector);
        mergedStyle = styleManager.getMergedStyleDeclaration(".verticalAxisStyle");
        style = new CSSStyleDeclaration(selector, styleManager, mergedStyle == null);
        ...
        conditions = null;
        conditions = [];
        condition = new CSSCondition("class", "blockNumericAxis");
        conditions.push(condition); 
        selector = new CSSSelector("", conditions, selector);
        mergedStyle = styleManager.getMergedStyleDeclaration(".blockNumericAxis");
        style = new CSSStyleDeclaration(selector, styleManager, mergedStyle == null);
        ...
        conditions = null;
        conditions = [];
        condition = new CSSCondition("class", "linedNumericAxis");
        conditions.push(condition); 
        selector = new CSSSelector("", conditions, selector);
        mergedStyle = styleManager.getMergedStyleDeclaration(".linedNumericAxis");
        style = new CSSStyleDeclaration(selector, styleManager, mergedStyle == null);
        ...
        conditions = null;
        conditions = [];
        condition = new CSSCondition("class", "dashedNumericAxis");
        conditions.push(condition); 
        selector = new CSSSelector("", conditions, selector);
        mergedStyle = styleManager.getMergedStyleDeclaration(".dashedNumericAxis");
        style = new CSSStyleDeclaration(selector, styleManager, mergedStyle == null);
        ...
        conditions = null;
        conditions = [];
        condition = new CSSCondition("class", "blockCategoryAxis");
        conditions.push(condition); 
        selector = new CSSSelector("", conditions, selector);
        mergedStyle = styleManager.getMergedStyleDeclaration(".blockCategoryAxis");
        style = new CSSStyleDeclaration(selector, styleManager, mergedStyle == null);
        ...
        conditions = null;
        conditions = [];
        condition = new CSSCondition("class", "hangingCategoryAxis");
        conditions.push(condition); 
        selector = new CSSSelector("", conditions, selector);
        mergedStyle = styleManager.getMergedStyleDeclaration(".hangingCategoryAxis");
        style = new CSSStyleDeclaration(selector, styleManager, mergedStyle == null);
        ...
        conditions = null;
        conditions = [];
        condition = new CSSCondition("class", "dashedCategoryAxis");
        conditions.push(condition); 
        selector = new CSSSelector("", conditions, selector);
        mergedStyle = styleManager.getMergedStyleDeclaration(".dashedCategoryAxis");
        style = new CSSStyleDeclaration(selector, styleManager, mergedStyle == null);
        ...
        conditions = null;
        conditions = [];
        condition = new CSSCondition("class", "horizontalGridLines");
        conditions.push(condition); 
        selector = new CSSSelector("", conditions, selector);
        mergedStyle = styleManager.getMergedStyleDeclaration(".horizontalGridLines");
        style = new CSSStyleDeclaration(selector, styleManager, mergedStyle == null);
        ...
        conditions = null;
        conditions = [];
        condition = new CSSCondition("class", "bothGridLines");
        conditions.push(condition); 
        selector = new CSSSelector("", conditions, selector);
        mergedStyle = styleManager.getMergedStyleDeclaration(".bothGridLines");
        style = new CSSStyleDeclaration(selector, styleManager, mergedStyle == null);
        ...
        conditions = null;
        conditions = null;
        selector = new CSSSelector("mx.charts.GridLines", conditions, selector);
        mergedStyle = styleManager.getMergedStyleDeclaration("mx.charts.GridLines");
        style = new CSSStyleDeclaration(selector, styleManager, mergedStyle == null);
        ...
        conditions = null;
        conditions = null;
        selector = new CSSSelector("mx.charts.Legend", conditions, selector);
        mergedStyle = styleManager.getMergedStyleDeclaration("mx.charts.Legend");
        style = new CSSStyleDeclaration(selector, styleManager, mergedStyle == null);
