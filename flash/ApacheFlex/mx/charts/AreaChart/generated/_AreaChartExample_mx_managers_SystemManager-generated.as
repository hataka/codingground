...
[ExcludeClass]
public class _AreaChartExample_mx_managers_SystemManager
    extends mx.managers.SystemManager
    implements IFlexModuleFactory, ISWFContext
{
    public function _AreaChartExample_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "AreaChartExample" : String(params[0]);
    ...
    override    public function info():Object
    {
        if (!_info)
        {
            ...
            compiledResourceBundleNames: [ "charts", "collections", "components", "containers", "core", "effects", "layout", "skins", "styles" ],
            currentDomain: ApplicationDomain.currentDomain,
            mainClassName: "AreaChartExample",
            mixins: [ "_AreaChartExample_FlexInit", "_AreaChartExample_Styles" ],
