 ...
 * file: GridLinesExample.php
 * path: F:\Flash\flex3.4\mxml\TourDeFlex\GridLinesExampleGridLinesExample\pgp
 * url:  http://hata2/Flash/ApacheFlex/mx/charts/GridLines//GridLinesExample.php
 * created: Time-stamp: <2010-09-21 15:35:01 kahata>
 * revision: $Id$
 * Programmed By: kahata
 * To compile:F:\Flash\flex3.4\flex_sdk_3.4.0.9271_mpl\bin\mxmlc.exe GridLinesExample.mxml
 * To run: 
 * link: 
 ...
 */
 ...
 //-----------設定 -------------
	$source = isset($_GET['file']) ? $_GET['file'] : 'GridLinesExample.mxml';
