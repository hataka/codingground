...
if(empty($_GET['dir'])){
	$filepath = str_replace('http://hata2/HomePage/travel.coocan','http://kahata.travel.coocan.jp','http://hata2/HomePage/travel.coocan/Flash/ApacheFlex/mx/charts/AxisRenderer/HLOCChartExample.mxml');
