 ...
 *================================================================
 * title: flex3sdk mxml?????????
 * file: BubbleChartExample.php
 * path: F:\Flash\flex3.4\mxml\TourDeFlex\BubbleChartExampleBubbleChartExample\pgp
 * url:  http://hata2/HomePage/travel.coocan/Flash/ApacheFlex/mx/charts/BubbleChart/BubbleChartExample.php
 * created: Time-stamp: <2010-09-21 15:35:01 kahata>
 * revision: $Id$
 * Programmed By: kahata
 * To compile:F:\Flash\flex3.4\flex_sdk_3.4.0.9271_mpl\bin\mxmlc.exe BubbleChartExample.mxml
 * To run: 
 * link: 
 ...
 */
 ...
 //-----------????-------------
	$source = isset($_GET['file']) ? $_GET['file'] : 'BubbleChartExample.mxml';
