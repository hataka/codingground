# Lesson8 アプリの連携
## Sample084 バッテリ状況を取得する p.215
インテントの中には、全ての通知するものもあります。例えばAndroid端末の電源の豆乳やバッテリ状態の変更などは、全てのアプリにインテントによって広く通知(ブロードキャスト)されます。  
このようなインテントを受信して処理するには、BroadcastRecieverクラスを拡張したクラスを使用します。  
