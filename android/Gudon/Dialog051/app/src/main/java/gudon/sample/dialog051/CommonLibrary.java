// -*- mode: java -*-  Time-stamp: <2012-03-03 9:33:31 kahata>
/*================================================================
 * title: Android CommonLibrary
 * file: CommonLibrary.java
 * path: F:\android\Gudon\Dialog05\src\gudon\sample\dialog05\CommonLibrary.java
 * url:  http://localhost/android/Gudon/Dialog05/src/gudon/sample/dialog05/CommonLibrary.java
 * created: Time-stamp: <2012-03-03 9:33:31 kahata>
 * revision: $Id$
 * Programmed By: kahata
 * To compile:
 * To run: 
 * link: 
 * description: Android CommonLibrary
 * 1.ダイアログ
 * 2.ファイル操作
 *================================================================*/

package gudon.sample.dialog051;
...
public class CommonLibrary {
	...
	// Yes No Cancel ダイアログ
	public static int showYesNoCancelDialog(final Activity activity,String title,String text)
	{
		AlertDialog.Builder ad =new AlertDialog.Builder(activity);
		ad.setTitle(title);
		ad.setMessage(text);
		...
		ad.create();
		ad.show();
		return CommonLibrary.dialogresult;
	}
	
	// Ok Cancel ダイアログ
	public static int showOkCancelDialog(final Activity activity,String title,String text)
	{	
		AlertDialog.Builder ad =new AlertDialog.Builder(activity);
		ad.setTitle(title);
		ad.setMessage(text);
	...
	// Yes No ダイアログ
	public static int showYesNoDialog(final Activity activity,String title,String text)
	{
		AlertDialog.Builder ad =new AlertDialog.Builder(activity);
		ad.setTitle(title);
		ad.setMessage(text);
	...
	// List ダイアログ
	public static int showListDialog(final Activity activity,String title,CharSequence[] items)
	{
		AlertDialog.Builder ad = new AlertDialog.Builder(activity);
		ad.setTitle(title);
		//ad.setMessage(text); //NG
		ad.setItems(items, new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int item) {
				CommonLibrary.dialogresult = item;
			}
		});
		ad.create();
		ad.show();
	...
	// ラジオボタン ダイアログ
	public static int showRadioDialog(final Activity activity,String title,CharSequence[] items)
	{
				AlertDialog.Builder ad = new AlertDialog.Builder(activity);
		ad.setTitle(title);
		//ad.setMessage(text); //NG
		ad.setSingleChoiceItems(items, CommonLibrary.dialogresult, new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int item) {
				CommonLibrary.dialogresult  = item;
			}
		});
