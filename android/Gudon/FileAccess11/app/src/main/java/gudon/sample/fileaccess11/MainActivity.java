...
public class MainActivity extends Activity {
	...
	*/
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		final File subDir= subdir2 = new File(fileDir,MainActivity.SUBDIR_NAME);
		if(!subDir.exists()){
			subDir.mkdir();
		}	    
		initializeView();
	...
	class SimpleClickListener implements OnClickListener
	{
		public void onClick(View v)
		{
			...
			try {
				File file = new File(MainActivity.subdir2,MainActivity.FILE_NAME);
			...
			try {
					FileInputStream inputStream = new FileInputStream(new File(
							MainActivity.subdir2, MainActivity.FILE_NAME));
					BufferedReader reader = new BufferedReader(
							new InputStreamReader(inputStream));
					String line;
					StringBuilder lines = new StringBuilder();
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (item.getItemId()) {
			case 0:
				//url = "http://192.168.1.53/f/android/Gudon/FileAccess10/src/gudon/sample/fileaccess10/FileAccess11Activity.java";
				url = "https://github.com/hataka/codingground/blob/master/android/Gudon/FileAccess11/app/src/main/java/gudon/sample/fileaccess11/MainActivity.java";
