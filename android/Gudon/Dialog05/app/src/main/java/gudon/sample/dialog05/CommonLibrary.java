...
public class CommonLibrary {
	...
	// List ダイアログ
	public static int showListDialog(final Activity activity,String title,String text, CharSequence[] items)
	{
		AlertDialog.Builder ad = new AlertDialog.Builder(activity);
		ad.setTitle(title);
	...
	// List ダイアログ
	public static int showRadioDialog(final Activity activity,String title,String text, CharSequence[] items)
	{
		AlertDialog.Builder ad = new AlertDialog.Builder(activity);
		ad.setTitle(title);
