		...
		readButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				try {
					...
					InputStream inputStream = res.openRawResource(R.raw.fileaccess09activity);
					...
					intent.setClassName("gudon.sample.fileaccess09", "gudon.sample.fileaccess09.SubActivity");
					// 次画面のアクティビティ起動
