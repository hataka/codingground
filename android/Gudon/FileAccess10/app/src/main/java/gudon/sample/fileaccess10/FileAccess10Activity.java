...
public class FileAccess10Activity extends Activity {
	...
	*/
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    myclasspath = new FileAccess10Activity().getClass().getName();
	    myclassname = new FileAccess10Activity().getClass().getSimpleName();
	...
	class SimpleClickListener implements OnClickListener
	{
		public void onClick(View v)
		{
			...
			File file = FileAccess10Activity.this.getFileStreamPath("FileAccess10Activity.java");  
			if ( file.exists() == false ) {  
				Resources res = FileAccess10Activity.this.getResources();  
		        try {  
		            ...
		            CommonLibrary.showDialog(FileAccess10Activity.this,	"エラー",msg);
		        }
			}
			...
			try {
				...
				CommonLibrary.showDialog(FileAccess10Activity.this,"エラー","ファイルの読込みに失敗しました。\n" + e.getMessage());
			}
		}
	}  
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		// メニューを追加
		menu.add(Menu.NONE, 0, Menu.NONE, "FileAccess10Activity.java");
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (item.getItemId()) {
			case 0:
				url = "http://192.168.24.92/android/Gudon/FileAccess10/src/gudon/sample/fileaccess10/FileAccess10Activity.java";
