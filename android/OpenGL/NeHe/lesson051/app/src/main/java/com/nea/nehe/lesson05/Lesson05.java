...
public class Lesson05 implements Renderer {
	...
	public void onDrawFrame(GL10 gl) {
		...
		gl.glRotatef(rquad, 1.0f, 1.0f, 1.0f); // Rotate the square about the x-axis (NEW)
		...
		gl.glRotatef(rtri, 0.0f, 1.0f, 0.0f); // Rotate the triangle about the y-axis (NEW)

		pyramid.draw(gl);						//Draw the Pyramid
		
		//Rotation
		rtri += 2.0f;// 0.2f; 					//Increase The Rotation Variable For The Pyramid
		rquad -= 1.5f;// 0.15f; 				//Decrease The Rotation Variable For The Cube
	}
