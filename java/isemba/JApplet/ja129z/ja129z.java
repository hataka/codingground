// -*- mode: java -*- Time-stamp: <2009-06-19 14:23:50 kahata>
/*====================================================================
 * name: ja129c.java 
 ...
 * To compile:
 * To run: ja129c.java のCodeViewerでのgeshi表示がおかしくなるので
 *    名前をja129c.java → ja129z.javaに変更して対処
 * links: 
...
public class ja129z extends JApplet {
  JPanel pane;
  ...
  private boolean inAnApplet = true;
    ...
    public ja129z(boolean inAnApplet) {
...
//    setContentPane(pane);
  ...
  class ja129zp extends JPanel {
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("Application: ja129z");
    	frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

        ja129z applet = new ja129z(false);
        applet.init();
