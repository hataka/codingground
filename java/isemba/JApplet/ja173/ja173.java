...
===================================================================================
 * プログラム名: ja173.java
 * 作成日: Time-stamp: <08/07/22(火) 18:16:50 hata>
...
//  << ja173.java >>
//
//  ＪＡｐｐｌｅｔ（５）：リモートホストやローカルホストのアプレットを使う
//  
...
//　・リモートホスト（アナログ時計）
//
//    <applet codebase="http://java.sun.com/applets/jdk/1.1/demo/Clock/"
//            code="Clock2.class"
//            width=300
//            height=200>
//    </applet>
...
//　・ローカルホスト（アナログ時計）
//
//    <applet codebase="file://c:/jsdk1.4.2_04/demo/applets/Clock/"
//            code="Clock.class"
//            width=300
//            height=200>
//    </applet>
...
public class ja173 extends Applet implements Runnable {
  Thread timer = null;
...
<applet codebase="http://localhost/java/isemba/JApplet/ja173/"
      code="Clock2.class"
      width=300
      height=200>
</applet>
