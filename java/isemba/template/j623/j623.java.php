 ...
 * @run: http://localhost/java/isemba/File/j623/j623.java.php
 * @link http://localhost/java/isemba/File/j623/j623.java
 * @link http://localhost:8080/manager/html/
 * @realpath F:\java\isemba\File\j623\j623.java
 * 説明: 
-----------------------------------------------------------------------------------
  j623
===================================================================================
...
<?php
    ...
    $ret = exec("type ".escapeshellarg("in.txt"),$lines);
    $output = join("\n",$lines);
    echo trim($output); 
...
<div style="color: #000000; background-color: #e9e8e2; font-family: Monospaced" width="100%">
<?php echo 'java '.$filebody.' 実行後 out.txt'; ?>
</div>

<pre style="padding:0.8em; background: #eee; color: black; border: 1px solid gray; margin-left:1em;margin-right:1em;">
<?php
	$lines = array();
    $ret = exec("type ".escapeshellarg("out.txt"),$lines);
    $output = join("\n",$lines);
    echo trim($output); 
?>
</pre>
...
<?php //if(file_exists('../include/'. 'memo.inc.php')) include('../include/'. 'memo.inc.php'); ?>
<?php if(file_exists('./include/'. 'memo.inc.php')) include('./include/'. 'memo.inc.php'); ?>
...
<?php //if(file_exists('../include/'. 'links.inc.php')) include('../include/'. 'links.inc.php'); ?>
<?php if(file_exists('./include/'. 'links.inc.php')) include('./include/'. 'links.inc.php'); ?>
...
<?php //if(file_exists('../include/'. 'keywords.inc.php')) include('../include/'. 'keywords.inc.php'); ?>
<?php if(file_exists('./include/'. 'keywords.inc.php')) include('./include/'. 'keywords.inc.php'); ?>
