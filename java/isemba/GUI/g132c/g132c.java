...
class g132c implements ActionListener {
  ...
  public void actionPerformed(ActionEvent e) {
    // ボタンがクリックされたとき、実行される。
    if( e.getActionCommand().equals("ボタン１") ) {
      lab.setText("ボタン１がクリックされた");
    } 
    if( e.getActionCommand().equals("ボタン２") ) {
...
<img src="g132ca.jpg" width=300 height=200>
<br><br>
ボタン１をクリック後<br>
<img src="g132cb.jpg" width=300 height=200>
<br><br>
ボタン２をクリック後<br>
<img src="g132cc.jpg" width=300 height=200>
