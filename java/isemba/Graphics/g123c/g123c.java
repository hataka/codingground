...
// パネルの定義。
class gp123c extends JPanel {

  double a,b;

  gp123c(double a, double b) { // コンストラクタ。 
    this.a = a; this.b = b;
  }
...
// フレームの定義。
class gf123c extends JFrame {
  gf123c(String t, double a, double b) { // コンストラクタ。
    super(t);
    // フレームからコンテントペインを取得。
    Container c = this.getContentPane();
    // パネルを生成し、フレームに追加。
    gp123c gp = new gp123c(a,b);
...
class g123c {
  public static void main(String[] args) {
    ...
    // フレーム生成。
    gf123c gf = new gf123c("リサージュ図形",a,b);
    // フレームの大きさを設定
    gf.setSize(300,200);
