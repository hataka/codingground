...
// パネルの定義。
class gp123b extends JPanel {

  double a,b;

  gp123b(double a, double b) { // コンストラクタ。 
    this.a = a; this.b = b;
  }
...
// フレームの定義。
class gf123b extends JFrame {
  gf123b(String t, double a, double b) { // コンストラクタ。
    super(t);
    // フレームからコンテントペインを取得。
    Container c = this.getContentPane();
    // パネルを生成し、フレームに追加。
    gp123b gp = new gp123b(a,b);
...
class g123b {
  public static void main(String[] args) {
    ...
    // フレーム生成。
    gf123b gf = new gf123b("リサージュ図形",a,b);
    // フレームの大きさを設定
    gf.setSize(300,200);
...
% java g123b 3.0 5.0
<img src="g123bc.jpg" width=300 height=200>
**/
