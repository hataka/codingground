...
/*====================================================================
 * name: j831d.java 
 * created : Time-stamp: <09/07/01(水) 17:19:13 hata>
 * $Id$
 * Programmed by kahata
 * To compile:
 * To run:
 * links: http://jubilo.cis.ibaraki.ac.jp/~isemba/PROGRAM/JAVA/java.shtml
 *   http://jubilo.cis.ibaraki.ac.jp/~isemba/PROGRAM/JAVA/APPLET/j831d.htm
 * description: Java プログラミング(基礎と応用)  仙波一郎
 * ====================================================================*/
////////////////////////////////////////////////////////////////////////////////
// << j831d.java >>
//
//  データ構造（３）：リスト（HashSetクラス、同期処理　対策１）
//
...
<pre>
% javac j831d.java
注: j831d.java の操作は、未チェックまたは安全ではありません。
